...
I2C0->F  |= I2C_F_ICR(0x03);					/* SCLdivider = Table 36-28. I2C divider and hold values. Reference Manual p.622 */
}
...
/**
 * @brief I2C wait after transmission.
 */
void i2c_wait(void) {
  timeout = 0;
...
/**
 * @brief I2C wait after receiving.
 */
void i2c_wait_rec(void) {
    timeout = 0;
    while ((((I2C0->S & I2C_S_IICIF_MASK) == 0) || ((I2C0->S & I2C_S_TCF_MASK) == 0)) && (timeout < 10000)) {
        timeout++;
    }
    if (timeout >= 10000) {
